...
class FluxKontextPipeline(
    ...
    def _unpack_latents(latents, height, width, vae_scale_factor):
        ...
        latents = latents.view(batch_size, height // 2, width // 2, channels // 4, 2, 2)  # bug (1, 32, 32, 16, 2, 2)
...
class FluxPipeline(FluxKontextPipeline):
    """Alias for backward compatibility. Use FluxKontextPipeline instead."""
    pass