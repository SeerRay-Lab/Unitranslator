...
sys.path.append(".")
from univa.models.qwen3vl.configuration_univa_qwen3vl import UnivaQwen3VLConfig
from univa.models.configuration_univa_denoise_tower import UnivaDenoiseTowerConfig
from univa.models.qwen3vl.modeling_univa_qwen3vl import (
    UnivaQwen3VLForConditionalGeneration,
)
...
def parse_args():
    ...
    parser.add_argument('--origin_flux_ckpt_path', type=str, default='/mnt/vlm-ks3/ljh/hf-model/FLUX.1-Kontext-dev',
                        help='Path to the original FLUX checkpoint')
    parser.add_argument('--origin_qwenvl_ckpt_path', type=str, default='/vlm-ssd/FoundationModel/mllm//Qwen3-VL-4B-Instruct',
                        help='Path to the QwenVL base model')
    parser.add_argument('--save_path', type=str, default='./UniWorld_Kontext_qwen3vl',
...
config = UnivaQwen3VLConfig.from_pretrained(origin_qwenvl_ckpt_path)
...
#######################################################################################
model = UnivaQwen3VLForConditionalGeneration._from_config(
    config, 
