...
from univa.models.configuration_univa_denoise_tower_v2 import UnivaDenoiseTowerConfig
...
def parse_args():
    ...
    parser.add_argument('--origin_qwenvl_ckpt_path', type=str, default='/mnt/vlm-ks3/ljh/hf-model/Qwen2.5-VL-3B-Instruct',
                        help='Path to the QwenVL base model')
    parser.add_argument('--save_path', type=str, default='./UniWorld_Kontext_3b_TF',
...
#######################################################################################
model = TFUnivaQwen2p5VLForConditionalGeneration._from_config(
    config, 
